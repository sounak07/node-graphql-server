...
const corsMW_1 = __importDefault(require("./api/middlewares/corsMW"));
const errorMW_1 = __importDefault(require("./api/middlewares/errorMW"));
const server = (0, express_1.default)();
server.use(corsMW_1.default);
server.use(bodyParser.json());
server.use(bodyParser.urlencoded({ extended: false }));
server.get('/health', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    res.status(200).send({ serverStatus: 'UP' });
}));
server.use('/v1', index_1.default);
server.use(errorMW_1.default);
